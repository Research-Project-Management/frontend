        ...
        <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              size="sm"
              className="h-8 gap-2 rounded-lg border-border/50 bg-background px-3 text-sm font-medium text-foreground/70 transition-all hover:bg-secondary/40 hover:text-foreground"
            >
          ...
          <DialogContent className="sm:max-w-[400px] border-none p-6" showCloseButton={false}>
