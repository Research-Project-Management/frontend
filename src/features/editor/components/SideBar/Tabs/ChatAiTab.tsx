...
// ΓöÇΓöÇ PDF Preview modal ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
      ...
      <div className="relative flex h-full flex-col bg-background">
                            ...
                            <AiEditSuggestionCard
                              ...
                              onApply={(edits) => {
                                ...
                                if (editor) {
                                  ...
                                  if (affected) highlightEditedLines(editor, affected.startLine, affected.endLine);
                                  toast.success("Γ£ô Re-applied edit", { duration: 2000 });
                                }
        ...
        {previewPending && (
          <div className="px-3 py-1.5 border-t border-border/40 bg-secondary/20 flex items-center gap-2 shrink-0">
            ...
            <span className="text-[10px] text-muted-foreground/60">compiling previewΓÇª</span>
          </div>
        )}

        {/* ΓöÇΓöÇ Input area ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
