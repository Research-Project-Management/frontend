            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <Input
                  ...
                  className="h-[30px] text-xs bg-transparent border-border/40 hover:border-border focus:border-primary/50 transition-colors placeholder:text-muted-foreground/25 font-mono"
                />
              </div>
