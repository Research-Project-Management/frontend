...
import type { ChatMessage, SourceItem } from "@/features/chat-ai/types/chat.types";
import { streamChatResponse, getChatSession, appendChatMessages, createChatSession, listChatSessions, deleteChatSession } from '@/features/chat-ai';
import { renderMarkdown } from "@/features/chat-ai/components/ai/layout/renderMarkdown";
import { cn } from "@/shared/lib/utils";

// â”€â”€ Think-block parser â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div className="w-full space-y-1.5">
              {["Summarize the key findings", "Explain the methodology", "What are the limitations?"].map(
                (prompt) => (
                  ...
                  >
                    <span className="shrink-0 text-primary/40 transition-colors group-hover:text-primary">â€º</span>
