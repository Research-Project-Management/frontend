...
function ColumnComponent({
      ...
      <div className="flex flex-col items-center w-10 shrink-0 bg-[#f4f5f7] rounded-sm py-2.5 gap-2.5">
        ...
        <TooltipProvider delayDuration={150}>
          <Tooltip>
            ...
            <TooltipContent side="top" sideOffset={6}>Expand column</TooltipContent>
          </Tooltip>
          ...
          {!isReadOnly && (
            <Tooltip>
              ...
              <TooltipContent side="top" sideOffset={6}>Add card</TooltipContent>
            </Tooltip>
          )}
  ...
  /* ── Expanded state ───────────────────────────────────────────────── */
  return (
    <div className={`flex flex-col w-85 shrink-0 rounded-sm transition-colors ${isOver ? "bg-accent" : "bg-muted/60"}`}>
      <div className="px-3 pt-3 pb-1">
        <div className="flex w-full items-center justify-between px-1 pb-1">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <span
              className="text-[13px] text-foreground/70 font-normal shrink-0"
            >
              {cards.length}
            </span>
          </div>
          ...
          <div className="flex items-center gap-0.5 shrink-0 ml-2">
            <TooltipProvider delayDuration={150}>
              <Tooltip>
                ...
                <TooltipContent side="top" sideOffset={6}>Collapse column</TooltipContent>
              </Tooltip>
