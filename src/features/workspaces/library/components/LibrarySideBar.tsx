      ...
      <div className="group/col relative">
        ...
        {renamingId === node._id ? (
          ...
          >
            ...
            >
              <div style={{ transform: hasChildren && open ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.15s' }}>
...
export default function LibrarySideBar() {
  ...
  return (
    <aside
      className="relative h-full bg-transparent flex flex-col select-none shrink-0"
      style={{ width: `${width}px` }}
    >
      {/* Header */}
      <div className="px-4 py-3.5 shrink-0">
        <span className="font-semibold text-xl tracking-tight text-foreground">Library</span>
      </div>
