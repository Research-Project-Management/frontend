          ...
          <div className="rounded-md border border-border bg-card p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-1">
              {[
                {
                  id: 'work-items',
                  title: 'Work Items Dataset',
                  desc: 'All work items with state, assignee, priority, labels, and completion status.',
                  ext: 'csv',
                  icon: FileText,
                },
                {
                  id: 'work-items-raw',
                  title: 'Raw Work Items JSON',
                  desc: 'Complete structured JSON dump including relations, assignees, and metadata.',
                  ext: 'json',
                  icon: FileDown,
                },
                {
                  ...
                  desc: 'Formatted markdown report with workflow counts and project overview.',
                  ext: 'md',
                  icon: Layers,
                },
                {
                  id: 'effort-timesheet',
                  title: 'Effort & Timeline Log',
                  desc: 'Detailed log of work item timelines, start/due dates, and time spent.',
                  ext: 'csv',
                  icon: Clock,
                },
              ].map((item) => {
                  ...
                  >
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-11 font-medium px-1.5 py-0.5 rounded bg-muted text-muted-foreground uppercase">
                          .{item.ext}
                        </span>
                      </div>
