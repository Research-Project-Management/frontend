        ...
        {isLoading ? (
          ...
          upcomingTasks.map((task: any) => {
            ...
            return (
              ...
              >
                {/* Date Square on Left */}
                <div className="h-10 w-10 flex flex-col items-center justify-center rounded-lg bg-muted text-foreground group-hover:bg-accent transition-colors shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-semibold text-foreground transition-colors whitespace-normal break-words">
                    {task.title}
                  </h4>
                  {projectInfo && (
                ...
                <div className="flex flex-col items-end gap-0.5 shrink-0">
                    <span className="text-[10px] font-bold text-muted-foreground/50 uppercase whitespace-nowrap transition-colors">
