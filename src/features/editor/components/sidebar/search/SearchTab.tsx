    ...
    <div className="flex h-full w-full flex-col overflow-hidden bg-card text-card-foreground">
      ...
      <div className="border-b border-border px-3 py-3 space-y-2">
        <div className="relative">
          <SearchIcon className="absolute left-2 top-1/2 -translate-y-1/2 size-4 text-muted-foreground shrink-0" />
          <Input
            value={query}
          ...
          {query && (
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 text-foreground outline-none"
            >
        ...
        {showReplace && (
          <div className="flex gap-1">
            <div className="relative flex-1">
              <Replace className="absolute left-2 top-1/2 -translate-y-1/2 size-4 text-muted-foreground shrink-0" />
              <Input
                value={replaceText}
        ...
        <div className="flex gap-1">
          {[
            ...
            <button
              ...
              className={cn(
                "h-7 rounded-md px-2 text-xs font-mono transition-colors outline-none cursor-pointer",
                opt.state
