  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-[440px] p-0 overflow-hidden z-[101] rounded-md border-0 shadow-2xl bg-white"
      >
        <div className="p-6">
          <DialogHeader className="flex flex-row items-start gap-4 space-y-0">
            ...
            <div className="min-w-0">
              <DialogTitle className="text-base font-semibold">Remove Quicklink?</DialogTitle>
        ...
        <div className="px-6 py-4 bg-gray-50/30 border-t border-gray-100">
          <DialogFooter className="flex w-full flex-row items-center justify-end gap-2 sm:justify-end">
            ...
            <Button
              ...
              disabled={isDeleting}
              className="h-9 px-6 text-[13px] font-bold bg-red-600 hover:bg-red-700 text-white shadow-none transition-all active:scale-95"
            >
              {isDeleting ? "Deleting..." : (
                <>
