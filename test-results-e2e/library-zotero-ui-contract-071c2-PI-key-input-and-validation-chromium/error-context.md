...
- Name: library-zotero-ui-contract.spec.ts >> Library & Zotero UI Contract Tests (Gate H) >> 2. Connect Account form has API key input and validation
- Location: tests\e2e\library-zotero-ui-contract.spec.ts:485:7
