...
export function TopBar({
  ...
  return (
    <header className="flex items-center justify-between px-6 md:px-10 lg:px-12 h-11 border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-10 shrink-0">
      <div
