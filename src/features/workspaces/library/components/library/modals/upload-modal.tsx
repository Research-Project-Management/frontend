...
import { useUpload } from '@/features/workspaces/library/hooks/library/use-upload';
import { extractMetadata } from '@/features/workspaces/library/utils/metadata';
...
export default function PaperUploadDialog({
  ...
  const { uploading, uploadedUrl, uploadToStorage, reset: resetUpload } = useUpload({ workspaceId });
