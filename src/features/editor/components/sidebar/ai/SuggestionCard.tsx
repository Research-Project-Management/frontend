...
function DiffViewer({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border bg-muted text-xs">
      <div className="flex min-h-7 items-center gap-2 border-b border-border bg-muted px-2.5">
        <span className="select-none font-sans text-xs font-semibold text-muted-foreground/70">
          Diff
        </span>
        {startLine > 0 && (
          <span className="ml-auto rounded-full border border-border bg-background/70 px-1.5 py-0.5 font-sans text-xs text-muted-foreground/60">
            line {startLine}
          </span>
        )}
      </div>
...
export function SuggestionCard({
  ...
  return (
    <div className="w-full overflow-hidden rounded-lg rounded-tl-sm border border-border bg-card">
        ...
        <div className="px-3.5 pt-2.5 pb-1">
          ...
          {editCount > 1 && (
            <button
              ...
              className="mt-1.5 flex w-full items-center gap-1.5 rounded-md px-2 py-1 text-left text-xs font-medium text-muted-foreground transition-colors hover:bg-muted outline-none cursor-pointer"
            >
      ...
      <div className="flex flex-wrap items-center gap-2 px-3.5 py-2.5">
        ...
        <button
          type="button"
          onClick={onDismiss}
          className="flex min-w-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-md border border-border px-3 py-1.5 text-sm text-foreground transition-colors hover:bg-muted sm:flex-none outline-none cursor-pointer"
        >
        ...
        {onRegenerate && (
          <button
            ...
            className="flex w-full items-center justify-center gap-1.5 rounded-md px-2.5 py-1.5 text-xs text-foreground transition-colors hover:bg-muted sm:ml-auto sm:w-auto outline-none cursor-pointer"
          >
