...
- Name: library-zotero-ui-contract.spec.ts >> Library & Zotero UI Contract Tests (Gate H) >> 4. Conflict Inbox displays mid-air collisions and allows resolution
- Location: tests\e2e\library-zotero-ui-contract.spec.ts:504:7
