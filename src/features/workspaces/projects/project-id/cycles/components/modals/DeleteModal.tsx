        ...
        <div className="px-6 py-4 bg-muted/30 border-t border-border">
          <DialogFooter className="flex w-full flex-row items-center justify-end gap-2 sm:justify-end">
            ...
            <Button
              ...
              onClick={onConfirm}
              disabled={isDeleting}
              className="h-9 px-6 text-sm font-medium bg-destructive hover:bg-destructive/90 text-destructive-foreground border-none shadow-none rounded-sm transition-all active:scale-95 cursor-pointer gap-1.5"
            >
              {isDeleting ? "Deleting..." : (
                <>
