...
export const ReferenceService = {
  ...
  resolve: (query: string) =>
    ...
    }>('/api/library/references/resolve', { query }),

  /**
   * Format Paper metadata into CSL Citation (APA, IEEE, Nature, Harvard, Chicago, MLA, Vancouver)
   */
  formatCitation: (
    workspaceId: string,
    paperId: string,
  ...
  /**
   * Batch Format CSL Citations for multiple papers
   */
  batchFormat: (
    workspaceId: string,
    paperIds: string[],
...
// Aliases
export const formatCslCitation = ReferenceService.formatCitation;
export const batchFormatCslCitations = ReferenceService.batchFormat;
export const resolveAcademicQuery = ReferenceService.resolve;
