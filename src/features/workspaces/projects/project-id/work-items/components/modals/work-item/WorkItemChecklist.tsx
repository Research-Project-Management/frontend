...
import type { Checklist } from '../../../types/work-item.types';

export type WorkItemChecklistProps = {
...
export type TaskChecklistProps = WorkItemChecklistProps;
...
export const TaskChecklist = WorkItemChecklist;
