    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md rounded-2xl border border-border/80 bg-card/95 backdrop-blur-md shadow-2xl p-7 relative z-10 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-3 pt-1">
          <div className="size-16 rounded-2xl border border-border/80 bg-muted/40 shadow-sm flex items-center justify-center overflow-hidden">
            {workspace.avatar ? (
              <img
        ...
        <div className="rounded-xl border border-border/70 bg-muted/20 p-4 space-y-3">
          ...
          <div className="pt-1 border-t border-border/50 flex items-center justify-between text-[11px] text-muted-foreground">
        ...
        <div className="space-y-3 pt-1">
          {user ? (
            ...
            <div className="space-y-2.5">
              <div className="text-center text-[11px] text-muted-foreground pb-0.5">
                Logged in as{' '}
            ...
            /* Not logged in state */
            <div className="space-y-2.5">
              <p className="text-center text-[11px] text-muted-foreground pb-0.5">
