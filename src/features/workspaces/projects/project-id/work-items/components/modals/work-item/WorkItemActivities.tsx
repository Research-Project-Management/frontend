                        ...
                        {isEditing ? (
                          <div className="mt-1.5 space-y-2 transition-all duration-200">
                            ...
                            <div className="flex items-center gap-2">
                              <Button
                                type="button"
                                className="h-9 min-w-16 bg-primary px-4 text-primary-foreground shadow-none transition-all duration-200 hover:bg-primary/90 active:scale-[0.98] disabled:opacity-60 cursor-pointer"
                              ...
                              <Button
                                type="button"
                                variant="ghost"
                                className="h-9 px-3 text-muted-foreground transition-all duration-200 hover:bg-muted active:scale-[0.98] disabled:opacity-60 cursor-pointer"
                            ...
                            <div className="relative mt-1.5 inline-flex items-center gap-2 text-sm text-muted-foreground">
                              ...
                              {item.permissions?.canEdit && !isReadOnly ? (
                                <>
                                  ...
                                  <button
                                    type="button"
                                    className="rounded px-1 py-0.5 transition-colors hover:bg-muted hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring active:scale-95 cursor-pointer"
