 ...
 *
 * Renders AS the assistant message bubble ΓÇö avatar is handled by the parent.
      ...
      <div className="max-h-56 overflow-auto font-mono">
        ...
        {oldLines.map((line, i) => (
          <div key={`r${i}`} className="grid grid-cols-[1.75rem_2.5rem_minmax(0,1fr)] border-b border-red-500/10 bg-red-500/7 text-red-500/80 last:border-b-0">
            <span className="select-none py-1.5 text-center font-semibold">ΓêÆ</span>
...
// ΓöÇΓöÇ Get "old text" from file content ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
