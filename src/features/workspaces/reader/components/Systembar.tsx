    ...
    <AnimatePresence>
      {selectedCount > 0 && (
        <motion.div
          ...
          className="fixed bottom-16 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 rounded-md border border-border bg-background px-3 py-1.5 shadow-raised-200 select-none"
        >
          {/* Selected Count */}
                  ...
                  <Tooltip delayDuration={200}>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className="size-4 rounded-full border border-border transition-transform hover:scale-125 focus:outline-none focus:ring-1 focus:ring-ring"
          ...
          <div className="flex items-center gap-1">
            {onAddToNote && (
              <Button
                ...
                onClick={onAddToNote}
                disabled={isProcessing}
                className="h-7 px-2 text-12 font-medium text-foreground hover:bg-muted"
              >
            ...
            {onBatchDelete && (
              <Button
                ...
                disabled={isProcessing}
                className="h-7 px-2 text-12 font-medium text-destructive hover:bg-destructive/10 hover:text-destructive"
              >
          ...
          <Button
            ...
            className="h-7 px-2 text-12 font-medium text-muted-foreground hover:text-foreground hover:bg-muted ml-1 cursor-pointer"
          >
            Clear
          </Button>
        </motion.div>
