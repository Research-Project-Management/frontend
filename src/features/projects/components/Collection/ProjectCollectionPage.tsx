...
import { useProjectCollections, useCreateProjectCollection, useDeleteProjectCollection, useImportLibraryCollection, useCollections } from '@/features/library';
...
// â”€â”€ Import from Library dialog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        <div className="space-y-3 py-1">
          <div className="space-y-1.5">
            ...
            <Select value={selected} onValueChange={setSelected}>
              <SelectTrigger>
                <SelectValue placeholder="Choose a collectionâ€¦" />
              </SelectTrigger>
              <SelectContent>
                {(collections ?? []).map((c) => (
...
// â”€â”€ Project Collection Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          <div className="min-w-0">
            ...
            {pc.sourceCollection && (
              <p className="text-xs text-muted-foreground truncate">
                â†³ from Library: {pc.sourceCollection.name}
              </p>
            )}
          </div>
        </div>
