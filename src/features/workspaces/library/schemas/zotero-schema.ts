/**
 * Frontend Zotero Official Metadata Schema & Item Types Definition
 * Based on https://github.com/zotero/zotero-schema and CSL JSON specification
 */
...
// ── 3. Complete Zotero Item Types Registry ──────────────────────────────────
export const ZOTERO_SCHEMA_ITEM_TYPES: Record<string, SchemaItemTypeDefinition> = {
  ...
  journalArticle: {
    ...
    fields: buildFields([
      ...
      'series', 'seriesTitle', 'seriesText', 'journalAbbreviation', 'DOI', 'ISSN', 'PMID', 'PMCID', 'arxivId',
  ...
  conferencePaper: {
    ...
    fields: buildFields([
      ...
      'volume', 'pages', 'series', 'date', 'DOI', 'ISBN', 'arxivId',
      'shortTitle', 'url', 'accessDate', 'archive', 'archiveLocation', 'libraryCatalog', 'callNumber',
      'rights', 'extra'
    ]),
  },
