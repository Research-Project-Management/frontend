...
const PINNED_STORAGE_KEY = "ai-pinned-chats";
...
export default function ChatHistoryModal({
  ...
  onSelectChat,
  title = "Chat History",
  description = "Find, rename, pin, or delete previous AI conversations.",
}: ChatHistoryModalProps) {
  const router = useRouter();
  const params = useParams() as { workspaceId?: string, chatId?: string };
