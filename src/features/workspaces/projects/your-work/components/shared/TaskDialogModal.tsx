...
import type { TaskMutationInput } from '@/features/workspaces/projects/project-id/work-items/types/work-item.types';
...
export function TaskDialogModal({
  ...
  return (
    <TaskDialog
      ...
      columns={columns}
      members={members}
      project={pDetails?.project || pDetails || (task?.project ? { id: projectId, ...task.project } : { id: projectId })}
      onSave={handleSave}
