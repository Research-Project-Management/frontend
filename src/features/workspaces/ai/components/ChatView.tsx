...
import { fetchCollectionPapers } from '@/features/workspaces/library/services/library.services';
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-2.5 line-clamp-1 text-xs text-foreground/50">
          {item.draft}
        </p>
      </div>
    </button>
...
export default function ChatView() {
  ...
  // projectId cá»§a session hiá»‡n táº¡i — Ä‘Æ°á»£c Ä‘á»c khi load history
