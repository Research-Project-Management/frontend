...
export default function DuplicatesPage() {
  ...
  const { data: duplicateData, isLoading: isDupLoading } = useDuplicateGroups(effectiveScopeId || workspaceId);
  const mergeMutation = useMergePapers(effectiveScopeId || workspaceId);
