...
import type { Task, Column, TaskMutationInput } from '../../types/task.types';
type TaskActivityLog = any;
              ...
              <div className="min-h-0 flex-1 px-9 pb-8 pt-8">
                <div className="flex items-center gap-3">
                  ...
                  <textarea
                    ...
                    className={`min-h-9 flex-1 resize-none overflow-hidden rounded-sm border border-transparent bg-transparent px-2 py-1 text-[24px] font-bold leading-tight outline-none placeholder:text-muted-foreground transition-all ${isReadOnly ? 'cursor-default' : 'hover:bg-muted focus:bg-background focus:border-border focus:ring-0 focus-visible:ring-0'} ${
                          ...
                          <div className="flex shrink-0 items-center gap-1 self-stretch">
                            ...
                            <div className="relative" data-attachment-menu-root="true">
                              ...
                              {activeAttachmentMenuId === item.id ? (
                                <div
                                  className={`absolute right-0 z-30 w-44 rounded-sm border border-border bg-popover p-1.5 shadow-xl ${
                                ...
                                >
                                  {attachmentMenuItems.map((menuItem) => (
                                    <button
                                      ...
                                      className={`flex w-full items-center rounded-sm px-3 py-2 text-left text-[14px] transition-colors cursor-pointer ${
