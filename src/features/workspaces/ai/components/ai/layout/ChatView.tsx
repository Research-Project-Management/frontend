 ...
 *
 * Route wiring:
 *   /:workspaceId/ai          â†’ index.tsx  â†’ re-exports this component (chatId = undefined)
 *   /:workspaceId/ai/:chatId  â†’ $chatId.tsx â†’ re-exports this component (chatId = string)
 *
 * New-chat flow:
 *   1. Welcome screen shown while no messages exist.
 *   2. User sends first message â†’ stream immediately (component transitions to chat view).
 *   3. After stream completes â†’ createChatSession with both messages atomically.
 *   4. router.push(/:workspaceId/ai/:id, {  state: { preloadedMessages } })
 ...
 *   1. chatId present â†’ load history via getChatSession (or preloadedMessages from state).
 *   2. Each send â†’ stream â†’ appendChatMessages to backend.
 */
...
import type { ChatMessage, SourceItem, AgentAction } from "@/features/workspaces/ai/types/chat.types";
...
import { fetchCollectionPapers } from '@/features/workspaces';
import { useWorkspace } from '@/features/workspaces';
import { toast } from "sonner";
import { useDocumentTitle } from "@/features/workspaces/ai/hooks/useDocumentTitle";
...
import { useChatMode } from "@/features/workspaces/ai/hooks/useChatMode";
import { cn } from "@/shared/lib/utils";

// â”€â”€ Agent metadata â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Think-block parser â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Sources list â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Message bubble â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Copy button â€” hover only, AI messages only */}
...
// â”€â”€ Typing indicator (three bouncing dots) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Welcome Screen with Agent Cards â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center overflow-y-auto px-4 py-8">
      ...
      <div className="flex group flex-col items-center mb-8">
        ...
        />
        <h3 className="font-semibold text-xl mb-1.5">Ask AI</h3>
        <p className="text-xs text-muted-foreground text-center max-w-xs leading-relaxed">
          Pick a workflow, refine the draft, then send when it feels right.
        </p>
      </div>

      {/* Agent capability cards â€” 2Ã—2 grid */}
...
export default function ChatView() {
  ...
  // projectId cá»§a session hiá»‡n táº¡i â€” Ä‘Æ°á»£c Ä‘á»c khi load history
  ...
  useEffect(() => {
    ...
    getChatSession(chatId)
      .then((session) => {
        ...
        // LÆ°u projectId cá»§a session Ä‘á»ƒ truyá»n cho dropdown trong ChatAi
  ...
  useEffect(() => {
    const preloadCollection: any = undefined;
  ...
  }, [addSource, undefined, setFluxDataEnabled, workspace?._id]);
    ...
    async (text: string, projectId?: string, webSearchSites?: string[], intentHint?: string) => {
      ...
      try {
        for await (const chunk of streamChatResponse(newMessages, {
          ...
          projectId,
          workspaceId,
          // RAG isolation â€” scope retrieval to this chat session only
        ...
        if (chatId) {
          // Existing session â€” persist the new exchange
          try {
          ...
          // New chat â€” create session atomically with the first exchange already inside
  ...
  // â”€â”€ Welcome screen: no session, not streaming, and no chat started yet â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Chat view â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  return (
      ...
      <div ref={scrollContainerRef} onScroll={handleScroll} className="flex-1 overflow-y-auto">
        {isLoadingHistory ? (
          ...
          <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
            ...
            {/* Streaming response â€” shown while tokens arrive */}
            {isStreaming && (
              <div className="space-y-1">
                ...
                {streamContent ? (
                  ...
                  /* Thinking indicator â€” shown before first token arrives */
