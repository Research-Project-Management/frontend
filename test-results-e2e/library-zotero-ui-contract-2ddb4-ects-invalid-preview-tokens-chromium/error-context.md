...
- Name: library-zotero-ui-contract.spec.ts >> Library & Zotero UI Contract Tests (Gate H) >> 5. URL Capture displays preview metadata and rejects invalid preview tokens
- Location: tests\e2e\library-zotero-ui-contract.spec.ts:512:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:2915/ws-test-e2e-g2/library
Call log:
  - navigating to "http://127.0.0.1:2915/ws-test-e2e-g2/library", waiting until "load"
