...
import { useFiles, useToggleStar, useDeleteFile } from "@/features/workspaces/storage/services/storage.services";
...
export default function StoragePage() {
  ...
  // W4: non-empty stub â€” FileExplorer uses its own internal RenameDialog
