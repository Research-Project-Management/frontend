...
describe("file-tree-builder", () => {
  it("should construct parent-child hierarchy and place main file first", () => {
    const pages = [
      { id: "p2", title: "chapter1.tex", parentId: "f1", isFolder: false },
      { id: "f1", title: "chapters", parentId: null, isFolder: true },
      { id: "p1", title: "main.tex", parentId: null, isFolder: false, isMain: true },
    ];
  ...
  it("should filter tree while keeping matching node hierarchy", () => {
    const pages = [
      { id: "p2", title: "results.tex", parentId: "f1", isFolder: false },
      { id: "p3", title: "intro.tex", parentId: "f1", isFolder: false },
      { id: "f1", title: "sections", parentId: null, isFolder: true },
    ];
