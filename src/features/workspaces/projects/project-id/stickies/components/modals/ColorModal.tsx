...
import { type StickyColor } from '@/features/workspaces/projects/project-id/stickies/types/sticky.types';
import { STICKY_COLOR_MAP } from '@/features/workspaces/projects/project-id/stickies/types/sticky.types';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
