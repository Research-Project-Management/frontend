...
import type { AgentAction, ResponseWidget } from "@/features/workspaces/ai/types/chat.types";
...
function buildTaskWidget(tool: string, output: Record<string, unknown>): ResponseWidget | null {
  ...
  return {
    type: "task_overview",
    title: tool === "get_my_tasks" ? "My Tasks" : String(output.projectName || "Task OverviewPage"),
