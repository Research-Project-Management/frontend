...
- Name: library-zotero-ui-contract.spec.ts >> Library & Zotero UI Contract Tests (Gate H) >> 1. OWNER can access Workspace Integrations and view Zotero Connection Panel
- Location: tests\e2e\library-zotero-ui-contract.spec.ts:475:7
...
```ts
  ...
  378 |     });
  379 | 
  380 |     // Intercept Zotero kill switch API
  381 |     await page.route(`**/api/v1/workspaces/${workspaceId}/library/integrations/zotero/kill-switch*`, async (route) => {
  382 |       const method = route.request().method();
  383 |       if (method === 'GET') {
  ...
  388 |             success: true,
  389 |             data: {
  390 |               globalDisabled: false,
  391 |               workspaceDisabled: false,
  392 |               reason: null,
  393 |             },
  394 |           }),
  395 |         });
