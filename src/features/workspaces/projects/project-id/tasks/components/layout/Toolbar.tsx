...
import type { Column } from "@/features/workspaces/projects/project-id/tasks/types/task.types";
import { resolveTaskColumnColor, resolveTaskColumnId } from "@/features/workspaces/projects/project-id/tasks/types/task.types";
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={`p-2 transition-colors cursor-pointer outline-none ${
                      viewMode === "board"
          ...
          {onAddExistingTask ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent
                ...
                className="w-48 p-1 rounded-sm shadow-xl border-border/40"
              >
                <DropdownMenuItem 
                  onClick={onAddTask}
                  disabled={isLoading || isReadOnly}
                ...
                >
                  ...
                  <span className="text-[13px] font-medium text-foreground">Add task</span>
                </DropdownMenuItem>
                <DropdownMenuItem 
                  ...
                  className="gap-2.5 py-2 cursor-pointer rounded-sm"
                >
                  <FolderOpen className="size-3.5 text-foreground" />
                  <span className="text-[13px] font-medium text-foreground">Add existing task</span>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          ) : (
