...
import { AGENT_CONFIGS } from "@/features/chat-ai/types/chat.types";
import type { AgentId } from "@/features/chat-ai/types/chat.types";
import { toast } from "sonner";

// Stable color cycle for projects â€” dot only, no new icons
    ...
    <div className="w-full max-w-3xl mx-auto px-4 pb-4">
      <div className="relative w-full group">
        ...
        <div className="relative rounded-2xl border border-border bg-background shadow-sm transition-shadow duration-300 focus-within:shadow-md focus-within:border-primary/30">
          ...
          {/* Quick-action chips â€” when agent selected and input is empty */}
